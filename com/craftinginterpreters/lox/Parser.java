...
public class Parser {
    ...
    private int loopDepth = 0; // Tracks nesting of loops
    ...
    private Stmt classDeclaration() {
        ...
        while (!check(RIGHT_BRACE) && !isAtEnd()){
            if (match(CLASS)) {
                Stmt.Function func = function("static method");
                //System.out.println(func.name.lexeme);
                statics.add(func);
            }
        ...
        /*for (Stmt.Function func : statics) {
            System.out.println(func.name.lexeme);
        }*/
    ...
    private Stmt forStatement() {
        ...
        loopDepth++; // Increment loop depth for 'break' handling
        Stmt body = statement();
        loopDepth--; // Decrement loop depth after the loop body  
    ...
    private Stmt breakStatement() {
        ...
        if (loopDepth == 0) {
            throw error(token, "Cannot use 'break' outside of a loop.");
        }
    ...
    private Expr primary() {
        ...
        if (match(
            ...
            SLASH, STAR
                ...
                Token last = previous();
                expression();
                throw error(last, "Expect left hand expression.");
            }
