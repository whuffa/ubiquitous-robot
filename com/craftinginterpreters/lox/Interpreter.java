...
public class Interpreter implements Expr.Visitor<Object>,
    ...
    private void checkZeroDivision(Token operator, Object right) {
        ...
        throw new RuntimeError(operator, "Second operand cannot be zero.");
    }
    ...
    private String trimInt(String number) {
        ...
        switch(expr.operator.type) {
            ...
            case PLUS:
                ...
                if (left instanceof String && right instanceof Double) {
                    return (String)left + trimInt(right.toString());
                }
                if (left instanceof Double && right instanceof String) {
                    return trimInt(left.toString()) + (String)right;
                }
